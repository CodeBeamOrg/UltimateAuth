...
public class EfCoreUserRoleStoreTests : EfCoreTestBase
{
    ...
    public async Task Assign_And_GetAssignments_Should_Work()
    {
        ...
        var store = new EfCoreUserRoleStore(db, new TenantContext(tenant));
    ...
    public async Task Should_Not_See_Data_From_Other_Tenant()
    {
        ...
        var store1 = new EfCoreUserRoleStore(db, new TenantContext(tenant1));
        var store2 = new EfCoreUserRoleStore(db, new TenantContext(tenant2));
