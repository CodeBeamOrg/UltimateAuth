...
public static class UAuthUsersModelBuilder
{
    ...
    private static void ConfigureIdentifiers(ModelBuilder b)
    {
    ...
    private static void ConfigureLifecycles(ModelBuilder b)
    {
