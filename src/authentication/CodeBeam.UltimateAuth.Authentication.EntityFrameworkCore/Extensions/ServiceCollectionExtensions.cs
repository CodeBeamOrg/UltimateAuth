...
{
    public static IServiceCollection AddUltimateAuthEntityFrameworkCoreAuthentication(this IServiceCollection services, Action<DbContextOptionsBuilder> configureDb)
    {
