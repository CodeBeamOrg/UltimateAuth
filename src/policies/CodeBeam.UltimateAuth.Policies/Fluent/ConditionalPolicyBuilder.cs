...
namespace CodeBeam.UltimateAuth.Policies
{
    internal sealed class ConditionalPolicyBuilder : IConditionalPolicyBuilder
    {
        ...
        public ConditionalPolicyBuilder(
            string prefix,
            Func<AccessContext, bool> condition,
        ...
        public IPolicyScopeBuilder Then()
            => new ConditionalScopeBuilder(_prefix, _condition, true, _registry, _services);

        public IPolicyScopeBuilder Otherwise()
            => new ConditionalScopeBuilder(_prefix, _condition, false, _registry, _services);
    }
