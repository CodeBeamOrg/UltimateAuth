...
internal sealed class AuthFlow : IAuthFlow
{
    private readonly IHttpContextAccessor _http;
    private readonly IAuthFlowContextFactory _factory;
    private readonly AuthFlowContextAccessor _accessor;

    public AuthFlow(IHttpContextAccessor http, IAuthFlowContextFactory factory, IAuthFlowContextAccessor accessor)
    {
        _http = http;
        _factory = factory;
        _accessor = (AuthFlowContextAccessor)accessor;
    }
